...
插件支持三种PDF生成模式，可根据个人阅读习惯选择：

**长图（无缝）模式**：将章节内所有漫画图片按顺序拼接成长图，再生成PDF，漫画每页之间无缝隙，适合在上下滑动的设备上使用，如手机或平板电脑。

**普通模式**：漫画每张图片为PDF中一页，将每页大小限制在一张A4纸大小内，尽可能填充满一块儿屏幕，适合在PDF阅读器或电脑上翻页阅读。
